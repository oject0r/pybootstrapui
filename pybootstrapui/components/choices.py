...
class Option(HTMLElement):
	...
	def __init__(self, label: str, selected: bool = False, value: str | None = None, classes: list[str] | None = None,
...
class Choice(HTMLElement):
	...
	def __init__(self, options: list[Option], name: str | None = None, classes: list[str] | None = None,
				 unique_id: str | None = None, on_choice: Union[Callable[..., None], Callable[..., Awaitable[None]]] = None):
		"""
