...
def run_page_in_desktop(page, nwjs_path, icon: str | None = None,
						title="NW.js App", width=800, height=600, resizable=True):
	"""
...
def build_package_json(title: str, width: int = 800, height: int = 600,
					   *, resizable: bool = True, name: str = 'nwjs-app',
					   icon: str | None = None,
					   version: str = '1.0.0', description: str = 'A NW.js application'
